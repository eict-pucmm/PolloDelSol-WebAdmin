...
app.get('/', function (req, res, next) {
    ...
    if (req.query.name == '' || !req.query.tipo)
        sql_query = 'SELECT empresa.id, cliente.nombre, empresa.RNC, cierre.tipo_de_cierre cierre.dia_ajustado, empresa.registrada FROM empresa, cliente, cierre WHERE empresa.id_cierre = cierre.id_cierre AND empresa.id_cliente = cliente.id_cliente;';
    else
        sql_query = `SELECT empresa.id, cliente.nombre, empresa.RNC, cierre.tipo_de_cierre cierre.dia_ajustado, empresa.registrada FROM empresa, cliente, cierre WHERE empresa.id_cierre = cierre.id_cierre AND empresa.id_cliente = cliente.id_cliente AND cliente.nombre = '${req.query.tipo}'`;
